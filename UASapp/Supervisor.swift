...
class Supervisor {
    ...
    init(apellido_materno:String,apellido_paterno: String,codigo_trabajador: String,correo: String,direccion: String,idEspecialidad: String,idSupervisor: Int,idUsuario: String,nombres: String,telefono:String,idpspprocess: String?,created_at:String?,updated_at:String?,deleted_at:String?) {
