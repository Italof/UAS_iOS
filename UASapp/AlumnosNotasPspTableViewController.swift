                ...
                for index1 in 0...(arregloNotas.count-1){
                  ...
                  var jsonResult = arregloNotas[index1] as! Dictionary<String, AnyObject>
                    ...
                    for index2 in 0...(arregloAlumnos.count-1){
                        ...
                        let idpspprocess = self.isNullInt(jsonResult:alumnoDiccionario,identificador: "idpspprocess")
                        let idespecialidad = self.isNullInt(jsonResult:alumnoDiccionario,identificador: "idespecialidad")
                      
                        alumnosT=PspStudent(id: alumnoDiccionario["id"]! as! Int,idalumno:alumnoDiccionario["idalumno"]! as! Int,idespecialidad: idespecialidad,idpspgroup:idpspgroup,idpspprocess: idpspprocess,idsupervisor: idsupervisor,created_at:created_at,updated_at:updated_at,deleted_at:deleted_at,idtipoestado:idtipoestado)
