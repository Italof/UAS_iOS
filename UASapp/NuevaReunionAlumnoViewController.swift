    ...
    override func viewDidLoad() {
        ...
        HTTPHelper.get(route: routeApi, authenticated: true, completion: {(error,data) in
            if error != nil {
                ...
                let idpspprocess:String? = self.isNullString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>,identificador: "idpspprocess")
                
                
                let apellido_materno:String = self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"apellido_materno")!
            
                let apellido_paterno:String = self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"apellido_paterno")!
                let codigo_trabajador:String = self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"codigo_trabajador")!
                let correo:String =  self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"correo")!
                let direccion:String = self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"direccion")!
                let idEspecialidad:String = self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"idfaculty")!
                
                let idSupervisor:Int = self.castDefinidoInt(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"id")!
                
                let idUsuario:String = self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"iduser")!
                let nombres:String = self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"nombres")!
                let telefono:String = self.castDefinidoString(jsonResult:validDictionary1 as! Dictionary<String, AnyObject>, identificador:"telefono")!
                
                self.supervisorA = Supervisor(apellido_materno:apellido_materno,apellido_paterno:apellido_paterno,codigo_trabajador: codigo_trabajador,correo: correo,direccion: direccion,idEspecialidad: idEspecialidad,idSupervisor: idSupervisor,idUsuario: idUsuario,nombres: nombres,telefono:telefono,idpspprocess:idpspprocess,created_at:created_at,updated_at:updated_at,deleted_at:deleted_at)
                ...
                for index in 0...(arregloFreeHour.count-1){
                    ...
                    let cantidad:Int = self.castDefinidoInt(jsonResult:jsonResult as! Dictionary<String, AnyObject>, identificador:"cantidad")!
                    
                    let fecha:String = self.castDefinidoString(jsonResult:jsonResult as! Dictionary<String, AnyObject>, identificador:"fecha")!
                    
                    
                    let hora_ini:Int = self.castDefinidoInt(jsonResult:jsonResult as! Dictionary<String, AnyObject>, identificador:"hora_ini")!
                    let id:Int = self.castDefinidoInt(jsonResult:jsonResult as! Dictionary<String, AnyObject>, identificador:"idsupervisor")!
                    let idsupervisorrr:Int = self.castDefinidoInt(jsonResult:jsonResult as! Dictionary<String, AnyObject>, identificador:"id")!
                    
                     pspFreeHourT = PspFreeHour(cantidad:cantidad,fecha:fecha,hora_ini:hora_ini,id:id,idsupervisor:idsupervisorrr,idpspprocess:idpspprocess,created_at:created_at,updated_at:updated_at,deleted_at:deleted_at)
                    
                  //  pspFreeHourT = PspFreeHour(cantidad:cantidad,fecha:jsonResult["fecha"]! as! String,hora_ini:jsonResult["hora_ini"]! as! Int,id:jsonResult["idsupervisor"]! as! Int,idsupervisor:jsonResult["id"]! as! Int,idpspprocess:idpspprocess,created_at:created_at,updated_at:updated_at,deleted_at:deleted_at)
