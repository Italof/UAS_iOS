...
class PspStudent {
    ...
    init(id:Int,idalumno:Int,idespecialidad:Int?,idpspgroup:Int?,idpspprocess:Int?,idsupervisor:Int?,created_at:String?,updated_at:String?,deleted_at:String?,idtipoestado:Int?) {
