...
class PspReuniones {
    ...
    init(asistencia: String?,fecha:String?,hora_fin:String?,hora_inicio:String?,idFreeHour:Int?,idMeeting:Int,idStudent:Int?,idSupervisor:Int?,idTipoEstado:Int?,lugar:String?,observaciones:String?,retroalimentacion:String?,tipoReunion:Int?,alumno:Alumnos?,created_at:String?,updated_at:String?,deleted_at:String?) {
