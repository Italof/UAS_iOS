//
//  PspDocumentosAlumnosTableViewController.swift
//  UASapp
//
...
class PspDocumentosAlumnosTableViewController: UITableViewController {
        ...
        override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            case kRedSection:
                ...
                cell.detailTextLabel!.text=codigo+"   "+self.pspDarray[indexPath.row].idtipoestado
        ...
        override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            if segue.identifier == "detalle" {
                if let indexPath = self.tableView.indexPathForSelectedRow {
                    if  let destinationVC = (segue.destination) as? DetalleDocumentoAlumnoViewController
                    {
